...
Automated build system for creating Windows portable packages of Pixvideo.
...
```
dist/windows/
├── Pixvideo-v*-win64/                  # Build directory (version number varies)
...
```bash
# Windows PowerShell
Get-FileHash Pixvideo-v*-win64.zip -Algorithm SHA256
```
...
Same as Pixvideo project license.
