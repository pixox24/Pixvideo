...
def render_style_config(pixelle_video):
    ...
    with st.container(border=True):
        ...
        if composition_mode == "plain_image":
            st.info(tr("style.plain_image_hint"))
    ...
    if composition_mode == "template":
        ...
        frame_template = st.session_state.get("selected_template", "1080x1920/image_default.html")
        ...
        custom_values_for_video = {}
        st.caption(tr("style.plain_image_size_info", width=media_width, height=media_height))
    # ====================================================================
    ...
    if template_requires_media:
        ...
        with st.container(border=True):
            ...
            if composition_mode == "plain_image":
                size_info_text = tr('style.plain_image_size_info', width=media_width, height=media_height)
